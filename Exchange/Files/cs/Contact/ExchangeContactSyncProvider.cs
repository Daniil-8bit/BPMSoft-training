namespace BPMSoft.Sync.Exchange
{
	...
	public class ExchangeContactSyncProviderImpl : ExchangeSyncProvider
	{
		...
		/// <summary>
		/// <see cref="BPMSoft.Core.UserConnection"/> instance.
		/// </summary>
		...
		private void AddContactsDynamicGroupFilters(
			...
			foreach (Entity folderEntity in folderEntities) {
				...
				var dataSourceFilters =
										Json.Deserialize<BPMSoft.Nui.ServiceModel.DataContract.Filters>(serializedFilters);
		...
		/// <summary>
		/// Fills exchange companies to BPMCRM account dictionary.
		/// </summary>
		/// <param name="context"><see cref="SyncContext"/> instance.</param>
		...
		/// <summary>
		///  Fills exchange address to BPMCRM address dictionary.
		/// </summary>
		/// <param name="context"><see cref="SyncContext"/> instance.</param>
