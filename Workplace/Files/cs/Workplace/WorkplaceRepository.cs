namespace BPMSoft.Configuration.Workplace
{
	...
	using BPMSoft.Configuration.Section;
	using BPMSoft.Configuration.Users;
	using BPMSoft.Core;
	...
	public class WorkplaceRepository : IWorkplaceRepository
	{
		...
		public bool SaveWorkplace(Workplace workplace) {
			...
			//TODO Delete "if condition" after task completion - sets name column value unconditionally.
